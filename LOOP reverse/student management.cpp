...
char student_dep[MAX_STUDENT_DEP];
...
fgets(addStudentInfoInDataBase.student_dep,MAX_STUDENT_DEP,stdin);
...
printf("\n\t\t\tStudent dep = %s\n",addStudentInfoInDataBase.student_dep);
